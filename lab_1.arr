...
extras = rectangle(100, 20, "solid", "black")
below(extras, above(extras, overlay-align("center", "top", circ1, overlay-align("center", "center", circ2, overlay-align("center", "bottom", circ3, back)))))
